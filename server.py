...
def Get_Volumes(array_name:str) -> json:
  """
    ...
    Returns:
      ...
      'provisioned': The provsioned volume size of the volume. The value type is 'int'. The unit is byte. Convert it into GiB. 
      'qos': QoS settings
        'bandwidth_limit': Sub-parameter of QoS settings. The bandwidth limit of the volume. The value type is 'int'. The unit is byte per second. Covert it into MiB per second.
        'iops_limit': Sub-parameter of QoS settings. The IOPS limit of the volume. The value type is 'int'.
      ...
      'used_space': The used space of the volume. The value type is 'int'. Original in byte, always convert to GiB/MiB(if less than 1 GiB).
      'pod': pod setting
        'id': Sub-parameter of Pod settings. The hash ID of the pod generated by FlashArray. The value type is 'str'.
        'name': Sub-parameter of Pod settings. The pod name which the volume belongs to.
      'volume_group': volume group information
        'id': Sub-parameter of volume group settings. The hash ID of the volume group generated by FlashArray.
        'name': Sub-parameter of volume group settings. The name of the volume group which the volume is belongs to.
  """
