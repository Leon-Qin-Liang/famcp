...
#-----------------------Tools for getting information from FlashArray start------------
# tool for listing all volumes' information
get_volumes_output_schema:{
  "type":"object",
  "properties":{
    "name":{
      "type":"string",
    ...
    "provisioned":{
      "type":"integer",
      "description":"The size of the volume which from the perspective of host. In bytes."
    },
    "qos":{
      "bandwidth_limit":{
        "type":"integer",
        "description":"The bandwidth limitation applied to the volume. In bytes. This is a sub-parameter of qos."
      },
      "iops_limit":{
        "type":"integer",
        "description":"The IOPS limitation applied to the volume. This is a sub-parameter of qos."
      }
    },
    "serial":{
      "type":"string",
    ...
    "data_reduction":{
      "type":"float",
      "description":"The data reduction rate of the volume."
    },
    "used_space":{
      "type":"integer",
      "description":"The used space of the volume. In byte."
    },
    "pod":{
      "id":{
        "type":"string",
        "descrption":"The hash ID of the pod. this is a sub-parameter of pod."
      },
      "name":{
        "type":"string",
        "description":"the name of the pod. this is a sub-parameter of pod."
      }
    },
    "volume_group":{
      "id":{
        "type":"string",
        "description":"the hash ID of the volume group. this is a sub-parameter of volume_group."
      },
      "name":{
        "type":"string",
        "description":"the name of the volume group. this is a sub-parameter of volume_group."
      }
    }
  }
}
...
def Get_Volumes(array_name:str) -> json:
  """
    List all existing volumes and related information, including volume name, provisioned volume size, qos settings, serial number, data reduction rate, used spaces, pod settings, and volume group settings, on a given Everpure FlashArray.
  ...
  results:json = fatools.Get_Volumes(current_client)
